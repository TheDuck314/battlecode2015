...
public class BotHQ extends Bot {
    ...
    enum Strategy {
        SOLDIERS_INTO_LAUNCHERS, PURE_LAUNCHERS, COMMANDER_INTO_LAUNCHERS
    }
    ...
    private static void chooseStrategy() {
        strategy = Strategy.COMMANDER_INTO_LAUNCHERS;
    }
    ...
    private static void directStrategy() throws GameActionException {
        switch (strategy) {
            ...
            case COMMANDER_INTO_LAUNCHERS:
                directStrategyCommanderIntoLaunchers();
                break;
        }
    }

    private static void directStrategyCommanderIntoLaunchers() throws GameActionException {
        RobotType desiredBuilding;

        // Choose what building to make
        if (numMinerFactories < 1) {
            desiredBuilding = RobotType.MINERFACTORY;
        } else if (numTechInstitutes < 1) {
