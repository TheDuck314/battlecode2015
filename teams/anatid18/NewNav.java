...
public class NewNav extends Bot {
    ...
    private static boolean move(Direction dir) throws GameActionException {
        rc.move(dir);
        Debug.indicate("nav", 2, "move(" + dir.toString() + ") ; isSafeToMove(dir) = " + safety.isSafeToMoveTo(here.add(dir))
                + "; inEnemyTowerOrHQRange(loc, enemyTowers) = " + inEnemyTowerOrHQRange(here.add(dir), rc.senseEnemyTowerLocations()));
        return true;
    }
