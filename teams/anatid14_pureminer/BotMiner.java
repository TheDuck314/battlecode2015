...
public class BotMiner extends Bot {
    ...
    public static void doMining() throws GameActionException {
        ...
        if(rc.senseNearbyRobots(RobotType.MINER.attackRadiusSquared, them).length > 0) {
            return; // don't compute or move while there are enemies to shoot
        }
