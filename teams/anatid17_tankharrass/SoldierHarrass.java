...
public class SoldierHarrass extends Bot {
    ...
    private static boolean tryStickToEnemyDrones() throws GameActionException {
        Debug.indicate("harrass", 0, "tryStickToEnemyDrones start");
        ...
        for (RobotInfo enemy : nearbyEnemies) {
            if (enemy.type == RobotType.DRONE || enemy.type == RobotType.SOLDIER) {
        ...
        Debug.indicate("harrass", 1, "closestEnemyDrone = " + (closestEnemyDrone == null ? "null" : closestEnemyDrone.location.toString()));
        Debug.indicate("harrass", 2, "");
