...
//                + " <= y <= " + mapMaxY);
        ...
        while (true) {
            System.out.println("startLoc = " + startLoc.toString());
    ...
    private static void analyzeProtectedRegion(MapLocation[] interior, int numInteriorSquares) throws GameActionException {
        ...
        double estimatedProtectedOre = numInteriorSquares * (totalVisibleOre / numVisibleInteriorSquares);
        ...
        double minProtectedMapFraction = numInteriorSquares / (double)maxPossibleMapSize;
        double maxProtectedMapFraction = numInteriorSquares / (double)minPossibleMapSize;
