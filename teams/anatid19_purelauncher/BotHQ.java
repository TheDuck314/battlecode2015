...
public class BotHQ extends Bot {
    ...
    private static void saveGameInfoToTeamMemory() throws GameActionException {
        ...
        int towerAdvantage = numTowers - enemyTowers.length;
        ...
        double hqHealthAdvantage = rc.getHealth() - theirHQHealth;

        int score = 10000 * towerAdvantage + (int) hqHealthAdvantage;
